...
VALUES
  ('Site','Admin','Other','admin','admin@example.com','<REPLACE_WITH_PASSWORD_HASH>','+0000000000','Admin','active'),
  ('Seller','One','Female','seller1','seller1@example.com','<REPLACE_WITH_PASSWORD_HASH>','+1111111111','Seller','active'),
  ('Buyer','One','Male','buyer1','buyer1@example.com','<REPLACE_WITH_PASSWORD_HASH>','+2222222222','Buyer','active');
